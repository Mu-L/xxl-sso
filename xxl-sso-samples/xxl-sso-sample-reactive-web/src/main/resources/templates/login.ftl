...
<head>
    ...
    <!-- iCheck -->
    <link rel="stylesheet" href="${springMacroRequestContext.contextPath}/static/adminlte/plugins/iCheck/square/blue.css">
    <!-- 1-style end -->
...
<script src="${springMacroRequestContext.contextPath}/static/adminlte/plugins/iCheck/icheck.min.js"></script>
<script>
    $(function(){
