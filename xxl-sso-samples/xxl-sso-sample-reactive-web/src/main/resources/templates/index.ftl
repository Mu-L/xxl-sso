...
<div class="wrapper">
    ...
    <header class="main-header">
        <a href="${springMacroRequestContext.contextPath}/" class="logo">
    ...
    <aside class="main-sidebar">
        <section class="sidebar">
            <ul class="sidebar-menu">
                ...
                <li class="nav-click active" ><a href="${springMacroRequestContext.contextPath}/"><i class="fa fa-circle-o text-gray"></i><span>使用教程</span></a></li>
            </ul>
        </section>
    </aside>
    <!-- 3-left end -->
    ...
    <footer class="main-footer">
        Powered by <b>XXL-SSO</b> 2.4.2-SNAPSHOT
...
<script src="${springMacroRequestContext.contextPath}/static/framework/admin.common.js"></script>
<!-- 6-script end -->
