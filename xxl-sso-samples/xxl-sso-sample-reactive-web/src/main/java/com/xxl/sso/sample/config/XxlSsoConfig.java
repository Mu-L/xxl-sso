...
import com.xxl.sso.core.auth.reactive.XxlSsoWebReactiveFilter;
...
public class XxlSsoConfig {
     ...
     */
    @Bean
    public XxlSsoWebReactiveFilter xxlSsoWebFilter() {

        // 2.1、build xxl-sso webflux filter
        return new XxlSsoWebReactiveFilter(excludedPaths, loginPath);
    }
