...
import com.xxl.sso.core.auth.reactive.XxlSsoCasReactiveFilter;
...
public class XxlSsoConfig {
     ...
     */
    @Bean
    public XxlSsoCasReactiveFilter xxlSsoCasFilter() {

        // 2.1、build xxl-sso webflux filter
        return new XxlSsoCasReactiveFilter(serverAddress, loginPath, excludedPaths);
    }
